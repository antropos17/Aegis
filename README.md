...
456 tests across 27 test files. Covers process scanning, file classification, network monitoring, risk scoring, anomaly detection, config management, baselines, logging, CLI, platform parsers, toast notifications, and demo mode. Uses [Vitest](https://vitest.dev/) with `v8` coverage.
