...
export function fixtureModes(args) {
  ...
  const deleteReview = args[0] === '--delete-review';
  return {
    crash,
    reviewCancellation,
    cancellation,
