...
Обновлено 2026-09-08 после возврата к backend и реальной проверки смерти ETW broker.
...
Текущий backend-блок — `codex/etw-crash-evidence`; проверь финальный статус PR.
...
Следующие задачи — управляемые реальные refusal/late-UAC и suspend проверки,
затем защищённое владение/восстановление при collector crash. E1/E2 ещё требуют
