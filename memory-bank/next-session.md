...
Обновлено 2026-09-08 после лёгкого UX-аудита Shield/Activity по просьбе пользователя.
...
Текущий UX-блок — ветка `codex/activity-ux-polish`; проверь финальный статус PR.
...
Большой фронтенд пользователь делает отдельно; группировка, названия скиллов и
текущий лёгкий UX-аудит отдельно разрешены. Продолжай по последнему запросу
пользователя, не переключайся обратно на ETW автоматически. Отвечать коротко,
