...
## Main Process (src/main/) — 177 CommonJS modules (154 top-level + 21 platform/ + 2 token-adapters/)
...
67 Svelte components, 16 stores, 22 utils. Component count refers to frontend/observatory/components; retained store/utility counts refer to src/renderer/lib.
