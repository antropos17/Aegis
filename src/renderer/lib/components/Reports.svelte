...
<div class="reports-section">
  ...
  <div class="export-row">
    <button class="export-btn" onclick={() => window.aegis?.exportLog()}>{$t('reports.overview.export_json')}</button>
    <button class="export-btn" onclick={() => window.aegis?.exportCsv()}>{$t('reports.overview.export_csv')}</button>
    <button class="export-btn" onclick={() => window.aegis?.generateReport()}>{$t('reports.overview.export_html')}</button>
  </div>
</div>
