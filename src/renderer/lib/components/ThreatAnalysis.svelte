  ...
  <div class="ta-controls">
    <div class="mode-row">
      <label class="mode-label">
        <input type="radio" name="ta-mode" value="session" bind:group={mode} />
        {$t('reports.threat.analyze_session')}
      </label>
      <label class="mode-label">
        <input type="radio" name="ta-mode" value="agent" bind:group={mode} />
        {$t('reports.threat.analyze_agent')}
      </label>
    </div>
