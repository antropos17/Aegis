<script>
  ...
  function close() { open = false; loaded = false; showKey = false; }
...
{#if open}
  ...
  <div class="overlay" role="dialog" aria-modal="true" tabindex="-1"
    onclick={close} onkeydown={handleKeydown}>
...
<style>
  .overlay {
    position: fixed; inset: 0; z-index: 200; background: var(--md-sys-color-scrim);
  ...
  .field-label { font: var(--md-sys-typescale-label-medium); color: var(--md-sys-color-on-surface-variant); }
  .field-hint { font: var(--md-sys-typescale-label-medium); color: var(--md-sys-color-on-surface-variant); opacity: 0.6; font-size: 10px; }

  .range-row { display: flex; align-items: center; gap: 10px; }
  .range-row input[type="range"] { flex: 1; accent-color: var(--md-sys-color-primary); }
  .range-val { font: var(--md-sys-typescale-label-medium); font-weight: 600; font-family: 'DM Mono', monospace; color: var(--md-sys-color-on-surface); min-width: 32px; text-align: right; }

  .toggle {
    position: relative; width: 40px; height: 22px; padding: 0; cursor: pointer; align-self: flex-start;
  ...
  .key-input, textarea {
    font: var(--md-sys-typescale-body-medium); font-family: 'DM Mono', monospace; font-size: 12px;
    padding: 8px 10px; background: var(--md-sys-color-surface-container);
  ...
  .toggle-vis {
    font: var(--md-sys-typescale-label-medium); font-weight: 600; padding: 6px 10px; cursor: pointer;
    background: var(--md-sys-color-surface-container); border: 1px solid var(--md-sys-color-outline);
    border-radius: var(--md-sys-shape-corner-small); color: var(--md-sys-color-on-surface-variant);
  }
