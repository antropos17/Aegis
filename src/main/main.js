...
function createWindow() {
  ...
  mainWindow = new BrowserWindow({ width: 1050, height: 800, minWidth: 820, minHeight: 560, title: 'AEGIS', backgroundColor: '#0c0c0e', webPreferences: { preload: path.join(__dirname, 'preload.js'), contextIsolation: true, nodeIntegration: false } });
