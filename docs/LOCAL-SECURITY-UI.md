...
| --- | --- | --- |
| Security scan | Directory and optional offline MCP tools/list JSON | STA001–STA018 findings, original file hashes/available lines, selected-source flow evidence, MCP description-relative lines and coverage gaps |
