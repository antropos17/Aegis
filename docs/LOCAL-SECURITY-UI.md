...
| --- | --- | --- |
| Security scan | Directory and optional offline MCP tools/list JSON | STA001–STA015 findings, original file hashes/lines, selected-source flow evidence, MCP description-relative lines and coverage gaps |
